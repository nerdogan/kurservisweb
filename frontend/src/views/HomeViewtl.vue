...
export default defineComponent({
  ...
  mounted() {
    axios.get<Item[]>('https://nenfuar.duckdns.org/fuar.php?masa=TL')
      .then(response => {
  ...
  methods: {
    handleSubmit() {
      ...
      this.description=parseFloat(((this.usd+2.0)*(this.milyem)*this.gramnum/1000).toFixed(2))
    }
  }
})
</script>
